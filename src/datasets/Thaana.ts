...
export const dataSet: CharacterSet = {
  ...
  endCode: 1983,
  characters: [
    { code: 1920, name: "THAANA LETTER HAA", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_0 },
    {
      code: 1921,
    ...
    { code: 1923, name: "THAANA LETTER RAA", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_0 },
    { code: 1924, name: "THAANA LETTER BAA", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_0 },
    {
      code: 1925,
    ...
    { code: 1940, name: "THAANA LETTER YAA", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_0 },
    {
      code: 1941,
    ...
    { code: 1948, name: "THAANA LETTER ZAA", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_0 },
    {
      code: 1949,
    ...
    { code: 1952, name: "THAANA LETTER TO", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_0 },
    { code: 1953, name: "THAANA LETTER ZO", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_0 },
    {
      code: 1954,
    ...
    { code: 1968, name: "THAANA SUKUN", cat: Category.Nonspacing_Mark, bidi: BidiClass.Nonspacing_Mark, age: Age.V3_0 },
    { code: 1969, name: "THAANA LETTER NAA", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V3_2 },
  ],
};
