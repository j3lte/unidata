...
export const dataSet: CharacterSet = {
  ...
  characters: [
    ...
    { code: 6731, name: "TAI THAM LETTER A", cat: Category.Other_Letter, bidi: BidiClass.Left_To_Right, age: Age.V5_2 },
    {
      code: 6732,
    ...
    { code: 6733, name: "TAI THAM LETTER I", cat: Category.Other_Letter, bidi: BidiClass.Left_To_Right, age: Age.V5_2 },
    {
      code: 6734,
    ...
    { code: 6735, name: "TAI THAM LETTER U", cat: Category.Other_Letter, bidi: BidiClass.Left_To_Right, age: Age.V5_2 },
    {
      code: 6736,
