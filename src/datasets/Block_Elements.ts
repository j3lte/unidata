...
export const dataSet: CharacterSet = {
  ...
  endCode: 9631,
  characters: [
    { code: 9600, name: "UPPER HALF BLOCK", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    {
      code: 9601,
    ...
    { code: 9604, name: "LOWER HALF BLOCK", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    {
      code: 9605,
    ...
    { code: 9608, name: "FULL BLOCK", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    {
      code: 9609,
    ...
    { code: 9612, name: "LEFT HALF BLOCK", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    {
      code: 9613,
    ...
    { code: 9616, name: "RIGHT HALF BLOCK", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    { code: 9617, name: "LIGHT SHADE", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    { code: 9618, name: "MEDIUM SHADE", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    { code: 9619, name: "DARK SHADE", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V1_1 },
    {
      code: 9620,
