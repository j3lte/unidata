...
export const dataSet: CharacterSet = {
  ...
  characters: [
    ...
    { code: 8175, name: "GREEK VARIA", cat: Category.Modifier_Symbol, bidi: BidiClass.Other_Neutral, decomp: [96] },
    {
      code: 8178,
    ...
    { code: 8189, name: "GREEK OXIA", cat: Category.Modifier_Symbol, bidi: BidiClass.Other_Neutral, decomp: [180] },
    {
      code: 8190,
      name: "GREEK DASIA",
      cat: Category.Modifier_Symbol,
