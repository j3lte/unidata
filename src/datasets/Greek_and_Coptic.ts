...
export const dataSet: CharacterSet = {
  ...
  characters: [
    ...
    { code: 885, name: "GREEK LOWER NUMERAL SIGN", cat: Category.Modifier_Symbol, bidi: BidiClass.Other_Neutral },
    {
      code: 886,
    ...
    { code: 1020, name: "GREEK RHO WITH STROKE SYMBOL", cat: Category.Lowercase_Letter, bidi: BidiClass.Left_To_Right },
    {
      code: 1021,
