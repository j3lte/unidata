...
export const dataSet: CharacterSet = {
  ...
  characters: [
    ...
    { code: 8586, name: "TURNED DIGIT TWO", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral },
    { code: 8587, name: "TURNED DIGIT THREE", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral },
  ],
};
