...
export const dataSet: CharacterSet = {
  ...
  endCode: 1791,
  characters: [
    { code: 1536, name: "ARABIC NUMBER SIGN", cat: Category.Format, bidi: BidiClass.Arabic_Number },
    { code: 1537, name: "ARABIC SIGN SANAH", cat: Category.Format, bidi: BidiClass.Arabic_Number },
    { code: 1538, name: "ARABIC FOOTNOTE MARKER", cat: Category.Format, bidi: BidiClass.Arabic_Number },
    { code: 1539, name: "ARABIC SIGN SAFHA", cat: Category.Format, bidi: BidiClass.Arabic_Number },
    { code: 1540, name: "ARABIC SIGN SAMVAT", cat: Category.Format, bidi: BidiClass.Arabic_Number },
    { code: 1541, name: "ARABIC NUMBER MARK ABOVE", cat: Category.Format, bidi: BidiClass.Arabic_Number },
    { code: 1542, name: "ARABIC-INDIC CUBE ROOT", cat: Category.Math_Symbol, bidi: BidiClass.Other_Neutral },
    { code: 1543, name: "ARABIC-INDIC FOURTH ROOT", cat: Category.Math_Symbol, bidi: BidiClass.Other_Neutral },
    { code: 1544, name: "ARABIC RAY", cat: Category.Math_Symbol, bidi: BidiClass.Arabic_Letter },
    {
      code: 1545,
    ...
    { code: 1547, name: "AFGHANI SIGN", cat: Category.Currency_Symbol, bidi: BidiClass.Arabic_Letter },
    { code: 1548, name: "ARABIC COMMA", cat: Category.Other_Punctuation, bidi: BidiClass.Common_Separator },
    { code: 1549, name: "ARABIC DATE SEPARATOR", cat: Category.Other_Punctuation, bidi: BidiClass.Arabic_Letter },
    { code: 1550, name: "ARABIC POETIC VERSE SIGN", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral },
    { code: 1551, name: "ARABIC SIGN MISRA", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral },
    {
      code: 1552,
    ...
    { code: 1563, name: "ARABIC SEMICOLON", cat: Category.Other_Punctuation, bidi: BidiClass.Arabic_Letter },
    { code: 1564, name: "ARABIC LETTER MARK", cat: Category.Format, bidi: BidiClass.Arabic_Letter },
    { code: 1565, name: "ARABIC END OF TEXT MARK", cat: Category.Other_Punctuation, bidi: BidiClass.Arabic_Letter },
    {
      code: 1566,
    ...
    { code: 1567, name: "ARABIC QUESTION MARK", cat: Category.Other_Punctuation, bidi: BidiClass.Arabic_Letter },
    { code: 1568, name: "ARABIC LETTER KASHMIRI YEH", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1569,
      name: "ARABIC LETTER HAMZA",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER HAMZAH",
    },
    {
      code: 1570,
    ...
    { code: 1575, name: "ARABIC LETTER ALEF", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1576,
      name: "ARABIC LETTER BEH",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER BAA",
    },
    {
      code: 1577,
    ...
    },
    {
      ...
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER THAA",
    },
    { code: 1580, name: "ARABIC LETTER JEEM", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1581,
      name: "ARABIC LETTER HAH",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER HAA",
    },
    {
      code: 1582,
      ...
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER KHAA",
    },
    { code: 1583, name: "ARABIC LETTER DAL", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1584, name: "ARABIC LETTER THAL", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1585,
      name: "ARABIC LETTER REH",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER RA",
    },
    { code: 1586, name: "ARABIC LETTER ZAIN", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1587, name: "ARABIC LETTER SEEN", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1588, name: "ARABIC LETTER SHEEN", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1589, name: "ARABIC LETTER SAD", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1590, name: "ARABIC LETTER DAD", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1591, name: "ARABIC LETTER TAH", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1592,
      name: "ARABIC LETTER ZAH",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER DHAH",
    },
    { code: 1593, name: "ARABIC LETTER AIN", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1594, name: "ARABIC LETTER GHAIN", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1595,
    ...
    { code: 1600, name: "ARABIC TATWEEL", cat: Category.Modifier_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1601,
      name: "ARABIC LETTER FEH",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER FA",
    },
    { code: 1602, name: "ARABIC LETTER QAF", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1603,
      name: "ARABIC LETTER KAF",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER CAF",
    },
    { code: 1604, name: "ARABIC LETTER LAM", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1605, name: "ARABIC LETTER MEEM", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1606, name: "ARABIC LETTER NOON", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1607,
      name: "ARABIC LETTER HEH",
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER HA",
    },
    { code: 1608, name: "ARABIC LETTER WAW", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1609,
    ...
    },
    {
      ...
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER YA",
    },
    { code: 1611, name: "ARABIC FATHATAN", cat: Category.Nonspacing_Mark, bidi: BidiClass.Nonspacing_Mark, comb: 27 },
    { code: 1612, name: "ARABIC DAMMATAN", cat: Category.Nonspacing_Mark, bidi: BidiClass.Nonspacing_Mark, comb: 28 },
    { code: 1613, name: "ARABIC KASRATAN", cat: Category.Nonspacing_Mark, bidi: BidiClass.Nonspacing_Mark, comb: 29 },
    {
      code: 1614,
      name: "ARABIC FATHA",
      cat: Category.Nonspacing_Mark,
    ...
    },
    {
      ...
      bidi: BidiClass.Nonspacing_Mark,
      comb: 33,
      oldName: "ARABIC SHADDAH",
    },
    { code: 1618, name: "ARABIC SUKUN", cat: Category.Nonspacing_Mark, bidi: BidiClass.Nonspacing_Mark, comb: 34 },
    {
      code: 1619,
    ...
    { code: 1625, name: "ARABIC ZWARAKAY", cat: Category.Nonspacing_Mark, bidi: BidiClass.Nonspacing_Mark, comb: 230 },
    {
      code: 1626,
    ...
    { code: 1642, name: "ARABIC PERCENT SIGN", cat: Category.Other_Punctuation, bidi: BidiClass.European_Terminator },
    { code: 1643, name: "ARABIC DECIMAL SEPARATOR", cat: Category.Other_Punctuation, bidi: BidiClass.Arabic_Number },
    { code: 1644, name: "ARABIC THOUSANDS SEPARATOR", cat: Category.Other_Punctuation, bidi: BidiClass.Arabic_Number },
    { code: 1645, name: "ARABIC FIVE POINTED STAR", cat: Category.Other_Punctuation, bidi: BidiClass.Arabic_Letter },
    { code: 1646, name: "ARABIC LETTER DOTLESS BEH", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1647, name: "ARABIC LETTER DOTLESS QAF", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1648,
    ...
    { code: 1673, name: "ARABIC LETTER DAL WITH RING", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1674, name: "ARABIC LETTER DAL WITH DOT BELOW", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1675,
    ...
    { code: 1703, name: "ARABIC LETTER QAF WITH DOT ABOVE", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1704,
    ...
    },
    {
      ...
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER OPEN CAF",
    },
    {
      code: 1706,
    ...
    { code: 1711, name: "ARABIC LETTER GAF", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1712, name: "ARABIC LETTER GAF WITH RING", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1713,
    ...
    { code: 1717, name: "ARABIC LETTER LAM WITH SMALL V", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1718, name: "ARABIC LETTER LAM WITH DOT ABOVE", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1719,
    ...
    { code: 1724, name: "ARABIC LETTER NOON WITH RING", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1725,
    ...
    { code: 1732, name: "ARABIC LETTER WAW WITH RING", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1733,
    ...
    },
    {
      ...
      cat: Category.Other_Letter,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC LETTER WAW WITH DAMMAH",
    },
    {
      code: 1736,
    ...
    { code: 1743, name: "ARABIC LETTER WAW WITH DOT ABOVE", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1744,
    ...
    },
    {
      ...
      cat: Category.Other_Punctuation,
      bidi: BidiClass.Arabic_Letter,
      oldName: "ARABIC PERIOD",
    },
    { code: 1749, name: "ARABIC LETTER AE", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1750,
    ...
    { code: 1757, name: "ARABIC END OF AYAH", cat: Category.Format, bidi: BidiClass.Arabic_Number },
    { code: 1758, name: "ARABIC START OF RUB EL HIZB", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral },
    {
      code: 1759,
    ...
    { code: 1765, name: "ARABIC SMALL WAW", cat: Category.Modifier_Letter, bidi: BidiClass.Arabic_Letter },
    { code: 1766, name: "ARABIC SMALL YEH", cat: Category.Modifier_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1767,
    ...
    { code: 1769, name: "ARABIC PLACE OF SAJDAH", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral },
    {
      code: 1770,
    ...
    { code: 1787, name: "ARABIC LETTER DAD WITH DOT BELOW", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter },
    {
      code: 1788,
    ...
    { code: 1789, name: "ARABIC SIGN SINDHI AMPERSAND", cat: Category.Other_Symbol, bidi: BidiClass.Arabic_Letter },
    {
      code: 1790,
