...
export const dataSet: CharacterSet = {
  ...
  endCode: 1791,
  characters: [
    { code: 1536, name: "ARABIC NUMBER SIGN", cat: Category.Format, bidi: BidiClass.Arabic_Number, age: Age.V4_0 },
    { code: 1537, name: "ARABIC SIGN SANAH", cat: Category.Format, bidi: BidiClass.Arabic_Number, age: Age.V4_0 },
    { code: 1538, name: "ARABIC FOOTNOTE MARKER", cat: Category.Format, bidi: BidiClass.Arabic_Number, age: Age.V4_0 },
    { code: 1539, name: "ARABIC SIGN SAFHA", cat: Category.Format, bidi: BidiClass.Arabic_Number, age: Age.V4_0 },
    { code: 1540, name: "ARABIC SIGN SAMVAT", cat: Category.Format, bidi: BidiClass.Arabic_Number, age: Age.V6_1 },
    {
      code: 1541,
    ...
    { code: 1544, name: "ARABIC RAY", cat: Category.Math_Symbol, bidi: BidiClass.Arabic_Letter, age: Age.V5_1 },
    {
      code: 1545,
    ...
    { code: 1547, name: "AFGHANI SIGN", cat: Category.Currency_Symbol, bidi: BidiClass.Arabic_Letter, age: Age.V4_1 },
    {
      code: 1548,
      name: "ARABIC COMMA",
      cat: Category.Other_Punctuation,
    ...
    { code: 1551, name: "ARABIC SIGN MISRA", cat: Category.Other_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V4_0 },
    {
      code: 1552,
    ...
    { code: 1564, name: "ARABIC LETTER MARK", cat: Category.Format, bidi: BidiClass.Arabic_Letter, age: Age.V6_3 },
    {
      code: 1565,
    ...
    { code: 1583, name: "ARABIC LETTER DAL", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1584,
    ...
    { code: 1589, name: "ARABIC LETTER SAD", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    { code: 1590, name: "ARABIC LETTER DAD", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    { code: 1591, name: "ARABIC LETTER TAH", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1592,
    ...
    { code: 1593, name: "ARABIC LETTER AIN", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1594,
    ...
    { code: 1600, name: "ARABIC TATWEEL", cat: Category.Modifier_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1601,
    ...
    { code: 1602, name: "ARABIC LETTER QAF", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1603,
    ...
    { code: 1604, name: "ARABIC LETTER LAM", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1605,
    ...
    { code: 1608, name: "ARABIC LETTER WAW", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1609,
    ...
    { code: 1711, name: "ARABIC LETTER GAF", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1712,
    ...
    { code: 1749, name: "ARABIC LETTER AE", cat: Category.Other_Letter, bidi: BidiClass.Arabic_Letter, age: Age.V1_1 },
    {
      code: 1750,
    ...
    { code: 1757, name: "ARABIC END OF AYAH", cat: Category.Format, bidi: BidiClass.Arabic_Number, age: Age.V1_1 },
    {
      code: 1758,
