...
export const dataSet: CharacterSet = {
  ...
  characters: [
    ...
    { code: 1371, name: "ARMENIAN EMPHASIS MARK", cat: Category.Other_Punctuation, bidi: BidiClass.Left_To_Right },
    { code: 1372, name: "ARMENIAN EXCLAMATION MARK", cat: Category.Other_Punctuation, bidi: BidiClass.Left_To_Right },
    { code: 1373, name: "ARMENIAN COMMA", cat: Category.Other_Punctuation, bidi: BidiClass.Left_To_Right },
    { code: 1374, name: "ARMENIAN QUESTION MARK", cat: Category.Other_Punctuation, bidi: BidiClass.Left_To_Right },
    { code: 1375, name: "ARMENIAN ABBREVIATION MARK", cat: Category.Other_Punctuation, bidi: BidiClass.Left_To_Right },
    {
      code: 1376,
    ...
    { code: 1418, name: "ARMENIAN HYPHEN", cat: Category.Dash_Punctuation, bidi: BidiClass.Other_Neutral },
    {
      code: 1421,
    ...
    { code: 1423, name: "ARMENIAN DRAM SIGN", cat: Category.Currency_Symbol, bidi: BidiClass.European_Terminator },
  ],
};
