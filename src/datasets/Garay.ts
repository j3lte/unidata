...
export const dataSet: CharacterSet = {
  ...
  characters: [
    ...
    { code: 68943, name: "GARAY SUKUN", cat: Category.Other_Letter, bidi: BidiClass.Right_To_Left, age: Age.V16_0 },
    {
      code: 68944,
    ...
    { code: 69006, name: "GARAY PLUS SIGN", cat: Category.Math_Symbol, bidi: BidiClass.Right_To_Left, age: Age.V16_0 },
    { code: 69007, name: "GARAY MINUS SIGN", cat: Category.Math_Symbol, bidi: BidiClass.Right_To_Left, age: Age.V16_0 },
  ],
};
