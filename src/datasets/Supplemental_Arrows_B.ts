...
export const dataSet: CharacterSet = {
  ...
  characters: [
    ...
    { code: 10620, name: "LEFT FISH TAIL", cat: Category.Math_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V3_2 },
    { code: 10621, name: "RIGHT FISH TAIL", cat: Category.Math_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V3_2 },
    { code: 10622, name: "UP FISH TAIL", cat: Category.Math_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V3_2 },
    { code: 10623, name: "DOWN FISH TAIL", cat: Category.Math_Symbol, bidi: BidiClass.Other_Neutral, age: Age.V3_2 },
  ],
};
